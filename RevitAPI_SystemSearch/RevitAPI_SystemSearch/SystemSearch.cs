// Geoff Overfield
// For use with Autodesk Revit API versions 2018+
// Iterates through a service of connected Elements
...
namespace RevitAPI_SystemSearch
{
    public class SystemSearch
    {
        ...
        public void RunStepThroughElements()
        {
            ...
            if ((m_lVistited.Count < m_lSelectedElts.Count) && (m_iLoops < MAX_LOOPS))
            {
        ...
        {
            if (pElt is Pipe) return ((Pipe)pElt)?.ConnectorManager?.Connectors;
